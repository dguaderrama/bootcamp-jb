 ...
 * dem-washington.tif
 ...
 ![Spatial Data Carpentry: Cartography in QGIS]({{site.baseurl}}{{ASSET_PATH}}/images/carto/carto-1.png)
...
<!--2. Create hillshade: * <em>Menu Bar > Raster > Analysis > DEM (Terrain models)</em> * Configure input as follows:<br> Notice the Z factor, this will exaggerate elevation and give the map an appearance of greater relief.<br>![Spatial Data Carpentry: Cartography in QGIS]({{site.baseurl}}{{ASSET_PATH}}/images/carto/carto-2.png) -->
 ...
 * Uncheck dem-washington layer.<br>
 ![Spatial Data Carpentry: Cartography in QGIS]({{site.baseurl}}{{ASSET_PATH}}/images/carto/carto-3.png)
 ...
 * QGIS does not load actual minimum and maximum values by default. This enables faster layer rendering. You'll want to load actual min/max values to visualize the correct data. To load actual min/max values:<br><em>Load min/max values: Min/max<br>Accuracy: Actual (slower)<br>Click Load<br>Click Apply to save changes</em><br>
 ![Spatial Data Carpentry: Cartography in QGIS]({{site.baseurl}}{{ASSET_PATH}}/images/carto/carto-4.png)
 ...
 * The product just created visualizes rock strength within Washington state with enhanced effects using hillshade and transparency.
 ![Spatial Data Carpentry: Cartography in QGIS]({{site.baseurl}}{{ASSET_PATH}}/images/carto/carto-5.png)
 ...
 * Print Composer toolbar icon<br>
 ![Spatial Data Carpentry: Cartography in QGIS]({{site.baseurl}}{{ASSET_PATH}}/images/carto/carto-6.png)
2. Create title:
 ...
 * **Add new map** toolbar icon:<br>
 ![Spatial Data Carpentry: Cartography in QGIS]({{site.baseurl}}{{ASSET_PATH}}/images/carto/carto-7.png)
 * **Move Item Content** tool will allow you to move the map without moving the bounding box<br>
 ![Spatial Data Carpentry: Cartography in QGIS]({{site.baseurl}}{{ASSET_PATH}}/images/carto/carto-8.png)
 ...
 * Notice how names and values are not appropriate for a final map. To open legend propertie, using the **Select/Move Item** tool: <em>Select the legend layer and notice the Item properties on the right</em><br>
 ![Spatial Data Carpentry: Cartography in QGIS]({{site.baseurl}}{{ASSET_PATH}}/images/carto/carto-9.png)
 * Item properties: Here you are able to change the title, select which legend to produce based on the map layer, modify legend item, etc. See the images below for the list of options.<br>
 ![Spatial Data Carpentry: Cartography in QGIS]({{site.baseurl}}{{ASSET_PATH}}/images/carto/carto-10.png)
 6. Add a title:
 * add title
 7. Add scale bar:
 * scale bar
 ...
 * As Image, PDF, or SVG.<br>
 <img src="{{site.baseurl}}{{ASSET_PATH}}/images/carto/carto-final-map.jpg" style="border:1px solid black;" alt="Spatial Data Carpentry: Cartography in QGIS">
