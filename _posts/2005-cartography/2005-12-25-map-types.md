...
The purpose of a thematic map is to emphasise the theme or subject area of a particular set of spatial data.  In this situation you'll notice there usually aren't many sets of data being visualized, typically a univariate or bivariate analysis used to convey the message.  Below are some common types of thematic maps.

### Choropleth

Choropleth maps are colored using a monochromatic theme to visualize the measurement of the statistical variable being displayed. A common theme is using Census data to create a choropleth map, such as normalizing unemployment by population to calculate an unemployment rate. Or simply counting the number of electoral votes per president during an election and visualizing with blue and red states.

#### Univariate

Below is a univariate choropleth map of the unemployment rate in June 2010. Source: [New York Times](http://www.nytimes.com/interactive/2009/03/03/us/20090303_LEONHARDT.html?scp=1&sq=recession%20map&st=cse&_r=0).
...
GISS Surface Temperature Analysis. Source: [NASA](http://data.giss.nasa.gov/gistemp/)
