...
Surface 
  : A topological 2-dimensional geometric primitive, locally representing a continuous image of a region of a plane.

Geometry Collection 
  : A geometric object that is a collection of some number of geometric objects. All the objects in a geometry collection must be in the sata spatial reference system.
